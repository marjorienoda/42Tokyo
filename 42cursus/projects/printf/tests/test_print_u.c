...
void	test_print_u(void)
{
	...
	printf("Test 6 (Orig):   [");
	fflush(stdout);
	orig = printf(" %u ", INT_MAX);
	printf("]\n");
	printf("Test 6 (Actual): [");
	fflush(stdout);
	ft = ft_printf(" %u ", INT_MAX);
	printf("]");
	print_result(orig, ft);
	// TEST 7
	printf("Test 7 (Orig):   [");
	fflush(stdout);
	orig = printf(" %u ", INT_MIN);
	printf("]\n");
	...
	printf("Test 5 (Orig):   [");
	fflush(stdout);
	orig = printf(" %u ", 9223372036854775807LL);
	printf("]\n");
	printf("Test 5 (Actual): [");
	fflush(stdout);
	...
	printf("Test 13 (Orig):   [");
	fflush(stdout);
	orig = printf(" %u %u ", -1, -100);
	printf("]\n");
	printf("Test 13 (Actual): [");
	fflush(stdout);
	ft = ft_printf(" %u %u ", -1, -100);
	printf("]");
	print_result(orig, ft);
	// TEST 14
	printf("Test 14 (Orig):   [");
	fflush(stdout);
	orig = printf(" %u %u ", 0, -19999);
	printf("]\n");
	printf("Test 14 (Actual): [");
	fflush(stdout);
	ft = ft_printf(" %u %u ", 0, -19999);
	printf("]");
	print_result(orig, ft);
	// TEST 15
	printf("Test 15 (Orig):   [");
	fflush(stdout);
	orig = printf(" %u %u ", INT_MAX, INT_MIN);
	printf("]\n");
	printf("Test 15 (Actual): [");
	fflush(stdout);
	ft = ft_printf(" %u %u ", INT_MAX, INT_MIN);
	printf("]");
	print_result(orig, ft);
}
